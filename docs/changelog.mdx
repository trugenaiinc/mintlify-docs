...
Knowledge Base architecture update and new Memory docs

### Key Features in This Release

- **Updated Knowledge Base internal architecture** to use collections backed by S3 storage, SQS-triggered Lambda processing (extract, clean, chunk, embed), and ingestion into a vector database. No public Knowledge Base APIs were changed.
- **Added Memory documentation page** describing how agents can use conversation and long-term memory, plus navigation entry under Managed Agents.
