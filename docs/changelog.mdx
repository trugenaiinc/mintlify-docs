...
- **Enhanced Knowledge Base:** we revised our entire knowledge layer architecture for improved reliability and overall performance. Our retrievels are today <100ms on an average.
